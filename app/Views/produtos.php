...
position: absolute;">
          ...
          <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">
              <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Vendas /</span> Produtos</h4>
              ...
              <!-- Striped Rows -->
              <div class="card">
                <div class = "d-flex align-items-baseline "><h5 class="card-header"><button type="button" class="btn btn-primary nova_especie" data-bs-toggle="modal" data-bs-target="#modalCenter">Novo Produto</button></h5>
...
<!-- <div class="modal fade " id="modalCenter" tabindex="-1"  aria-hidden="true" role="dialog">
                ...
                <div class="table-responsive text-nowrap">
                  ...
                  <table class="table table-striped">
                    <thead>
                      <tr>
                        <th>Categoria <a class='bx bx-sort' href="?par=cod&order=<?=$order?>" ></a></th>
                        <th>NCM <a class='bx bx-sort' href="?par=nome_cientifico&order=<?=$order?>" ></a></th></th>
                        <th>Código <a class='bx bx-sort' href="?par=nome_popular&order=<?=$order?>" ></a></th></th>
                        <th></th>
                        <th></th>
                      </tr>
                    </thead>
